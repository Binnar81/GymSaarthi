      ...
      <section>
        ...
        <div className="py-[10rem] container gap-16 page-padding grid grid-cols-[64fr_35fr] md1000:grid-cols-1 md1000:gap-32">
          ...
          <div className="flex flex-col gap-28">
            ...
            />
            <BlogBox img={Img3} title="Meet Our Fitness Ambassador Jenny" />
            <BlogBox img={Img4} title="The Best are Asian Materls Direct" />
            <BlogBox
              img={Img5}
              ...
              <div className="flex flex-col gap-7">
                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col gap-4 justify-center">
                    ...
                    <p className="text-[16px] text-black hover:text-[#ff0336] ease-in duration-200 cursor-pointer font-bold">
                      The best are Asian Meditation Practitioner
                    </p>
                  </div>
                </div>
                {/*  */}
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col gap-4 justify-center">
                    ...
                    <p className="text-[16px] text-black hover:text-[#ff0336] ease-in duration-200 cursor-pointer font-bold">
                      Learn Boxing With Our Trainer Sam
                    </p>
                  </div>
                </div>
                {/*  */}
