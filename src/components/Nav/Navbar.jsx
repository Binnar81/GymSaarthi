...
function Navbar() {
  ...
  return (
    ...
    <h1 className="text-white text-4xl font-bold">GymSaarthi</h1>
        </div>
        </Link>
              ...
              >
                ...
                <img
                  src={Logo}
                   ...
                   onClick={goTop}
                   className="w-auto h-auto" />
                  <h1 className="text-black text-4xl font-bold">GymSaarthi</h1>
        </div>
        </Link>
                  <i
                    onClick={sideBar}
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex gap-5">
                    ...
                    <span className="bg-[#ff0336] rounded-full py-[12px] px-[12px] cursor-pointer">
                      <i className="fa-brands fa-github text-[2.2rem] text-white"></i>
                    </span>
                    <span className="bg-[#ff0336] rounded-full py-[10px] px-[13px] cursor-pointer">
                      <i className="fa-brands fa-linkedin-in text-[2.2rem] text-white"></i>
                    </span>
                  </div>
                </div>
              </div>
