        ...
        <div className="container page-padding py-[10rem]">
          ...
          <div className="flex flex-col text-center relative items-center">
            ...
            <p className="text-[#646464] font-medium text-[15px] ">
              GymSaarthi an unknown printer took a galley of type and scrambled
          ...
          <div className="flex gap-6 w-full mt-[5rem] md1200:justify-center flex-wrap">
            ...
            <BlogBox
              bgClass="box3Bg"
              date="28.10.2023"
              title="Meet Fitness Ambassador Jenny"
              description="Get to know Jenny, a fitness enthusiast and dedicated ambassador who is passionate about helping others reach their fitness goals."
            />
          </div>
        </div>
      </section>
