...
function Testimonials() {
  const testimonialsData=[
    {id:1,text:" “I've been a member of GymSaarthi for the past 2 year and it has been an amazing experience. The trainers are knowledgeable and supportive, the equipment is top-notch, and the community of members is friendly and encouraging.”",
  name:"Sam Altman", job:"Open AI CEO"
  },
    {id:1,text:" “I've been a member of GymSaarthi for the past 9 months and it has been an amazing experience. The trainers are knowledgeable and supportive, the equipment is top-notch, and the community of members is friendly and encouraging.”",
  name:"Virat Kohli", job:"Indian Cricketer"
  },
  {id:1,text:" “I've been a member of GymSaarthi for the past 12 months and it has been an amazing experience. The trainers are knowledgeable and supportive, the equipment is top-notch, and the community of members is friendly and encouraging.”",
  name:"Elon Musk", job:"Space X Founder"
  },
  {id:1,text:" “I've been a member of GymSaarthi for the past 2 year and it has been an amazing experience. The trainers are knowledgeable and supportive, the equipment is top-notch, and the community of members is friendly and encouraging.”",
  name:"Sundar Pichai", job:"Google CEO"
  },
  {id:1,text:" “I've been a member of GymSaarthi for the past 5 year and it has been an amazing experience. The trainers are knowledgeable and supportive, the equipment is top-notch, and the community of members is friendly and encouraging.”",
  name:"Brock Lesner", job:"WWE Universal Champion"
  }
  ]
        ...
        <div className="container page-padding">
          ...
          <div className="border-[#efefef] mt-[17rem] md1000:mt-[9rem] bg-white border-solid border-[9px] p-[30px] min540:h-[48rem] min375:h-[60rem]">
            <div className="bg-black overflow-x-clip w-full h-[33rem] relative">
              ...
              <div className="flex">
                {/* text box */}
                <TestimonialBoxes testimonials={[testimonialsData[currentIndex]]} currentIndex={currentIndex}/>
              </div>
