import FooterLogo from "../../images/logo/favicon-32x32.png";
            ...
            <div className="flex flex-col w-1/3 gap-8">
             ...
             <h1 className="text-[22px] font-bold footer-main">GymSaarthi</h1>
              ...
              <div className="flex gap-7 text-[18px] text-[#646464] min540:justify-center">
                <a href="https://github.com/Binnar81">
                <i
                  style={{ transition: "all 0.3s" }}
                  className="fa-brands fa-github bg-[#efefef] p-4 rounded-full px-[14px] hover:bg-[#ff0366] hover:text-white"
                ></i>
                </a>
               ...
               <a href="https://www.linkedin.com/in/sanjay-binnar/" >
                <i
                  style={{ transition: "all 0.3s" }}
                  className="fa-brands fa-linkedin-in bg-[#efefef] p-4 rounded-full px-[14px] hover:bg-[#ff0366] hover:text-white"
                ></i>
                </a>
              ...
              <p className="text-[16px] font-medium text-[#646464]">
                Privacy Policy | © {new Date().getFullYear()} GymSaarthi <br />{" "}
